...
Purpose:
    Test full pipeline for exporting and loading CSC data using the SessionMetadata class.
"""
...
from utils.io_trodes import parse_trodesconf, export_csc_to_binary, load_csc_binary
from utils.logger import logger

# --- SETUP ---
rat_id = "NC40008"
session_name = "20250328_134136"
session = SessionMetadata(rat_id=rat_id, session_name=session_name)
...
# --- EXPORT ---
export_csc_to_binary(session)

# --- VERIFY ---
recording = load_csc_binary(session)
